...
namespace Confast.Web.Data.Migrations
{
    ...
    [Migration("20260918191231_CaptureStartedProductionForecast")]
    partial class CaptureStartedProductionForecast
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Confast.Web.Features.ContainerTracking.ContainerGroupPart", b =>
                {
                    ...
                    b.Property<int?>("ActualReceivedQuantity")
                        .HasColumnType("integer")
                        .HasColumnName("actual_received_quantity");
            ...
            modelBuilder.Entity("Confast.Web.Features.ContainerTracking.ContainerReceiptAllocation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("ContainerGroupPartId")
                        .HasColumnType("bigint")
                        .HasColumnName("container_group_part_id");

                    b.Property<bool>("EstablishedDestinationManufacturerLot")
                        .HasColumnType("boolean")
                        .HasColumnName("established_destination_manufacturer_lot");
                    ...
                    b.Property<string>("ManufacturerLotEstablishmentReason")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("manufacturer_lot_establishment_reason");
                    ...
                    b.HasIndex("OperationId")
                        .IsUnique()
                        .HasDatabaseName("UX_container_receipt_allocations_operation_id");

                    b.ToTable("container_receipt_allocations", null, t =>
                        {
            ...
            modelBuilder.Entity("Confast.Web.Features.ContainerTracking.ContainerReceiptHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateOnly?>("PreviousReceivedDate")
                        .HasColumnType("date")
                        .HasColumnName("previous_received_date");
                    ...
                    b.ToTable("container_receipt_history", (string)null);
                });

            modelBuilder.Entity("Confast.Web.Features.ContainerTracking.ContainerReceivedQuantityHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("container_received_quantity_history", null, t =>
                        {
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.DefaultWorkingDay", b =>
                {
                    ...
                    b.HasKey("SettingsId", "Day");

                    b.ToTable("production_default_working_days", null, t =>
                        {
                            t.HasCheckConstraint("ck_default_machine_hours", "day BETWEEN 0 AND 6 AND hours = round(hours, 1) AND hours >= 0 AND hours <= 24");
                        });
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.DowntimeReason", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.MachineDowntime", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("machine_downtime", null, t =>
                        {
                            t.HasCheckConstraint("ck_downtime_dates", "\"end\" >= start");
                        });
                });

            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.MachineWorkingDay", b =>
                {
                    b.Property<long>("MachineId")
                        .HasColumnType("bigint")
                        .HasColumnName("machine_id");
                    ...
                    b.HasKey("MachineId", "Day");

                    b.ToTable("machine_working_days", null, t =>
                        {
                            t.HasCheckConstraint("ck_machine_hours", "day BETWEEN 0 AND 6 AND hours = round(hours, 1) AND hours >= 0 AND hours <= 24");
                        });
                });

            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.PartMachine", b =>
                {
                    b.Property<long>("MachineId")
                        .HasColumnType("bigint")
                        .HasColumnName("machine_id");
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.ProductionAudit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("production_audit", (string)null);
                });

            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.ProductionHoliday", b =>
                {
                    ...
                    b.ToTable("production_holidays", (string)null);
                });
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.ProductionJob", b =>
                {
                    ...
                    b.ToTable("production_jobs", null, t =>
                        {
                            t.HasCheckConstraint("ck_job_quantity", "quantity > 0");
                        });
                });

            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.ProductionProgress", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.ProductionRequirement", b =>
                {
                    ...
                    b.Property<decimal>("CumulativeTarget")
                        .HasPrecision(24, 6)
                        .HasColumnType("numeric(24,6)")
                        .HasColumnName("cumulative_target");
                    ...
                    b.ToTable("production_requirements", null, t =>
                        {
                            t.HasCheckConstraint("ck_requirement_quantity", "cumulative_target > 0");
                        });
                });
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.ProductionSegment", b =>
                {
                    ...
                    b.Property<decimal?>("ActualElapsedWorkingDays")
                        .HasColumnType("numeric")
                        .HasColumnName("actual_elapsed_working_days");
                    ...
                    b.Property<DateOnly?>("NotBefore")
                        .HasColumnType("date")
                        .HasColumnName("not_before");

                    b.Property<decimal>("OriginalEfficiencyPercent")
                        .HasPrecision(24, 6)
                        .HasColumnType("numeric(24,6)")
                        .HasColumnName("original_efficiency_percent");

                    b.Property<decimal>("OriginalHours")
                        .HasPrecision(24, 6)
                        .HasColumnType("numeric(24,6)")
                        .HasColumnName("original_hours");

                    b.Property<decimal>("OriginalTargetPph")
                        .HasPrecision(24, 6)
                        .HasColumnType("numeric(24,6)")
                        .HasColumnName("original_target_pph");

                    b.Property<long?>("PredecessorId")
                        .HasColumnType("bigint")
                        .HasColumnName("predecessor_id");

                    b.Property<DateOnly?>("ProgressAsOf")
                        .HasColumnType("date")
                        .HasColumnName("progress_as_of");
                    ...
                    b.Property<DateOnly?>("StartedForecastFinish")
                        .HasColumnType("date")
                        .HasColumnName("started_forecast_finish");

                    b.Property<DateOnly?>("StartedForecastStart")
                        .HasColumnType("date")
                        .HasColumnName("started_forecast_start");
                    ...
                    b.ToTable("production_segments", null, t =>
                        {
                            t.HasCheckConstraint("ck_segment_quantity", "quantity >= 0 AND completed_quantity >= 0 AND completed_quantity <= quantity AND state BETWEEN 0 AND 2 AND (state <> 2 OR completed_quantity = quantity)");
                        });
                });

            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.ProductionSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("production_settings", null, t =>
                        {
                            t.HasCheckConstraint("ck_production_efficiency", "id = 1 AND efficiency_percent = trunc(efficiency_percent) AND efficiency_percent > 0 AND efficiency_percent <= 100");
                        });
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            EfficiencyPercent = 91m,
                            Revision = 0L,
                            Version = 0u
                        });
                });

            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.SortingMachine", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("UsesDefaultWorkingDays")
                        .HasColumnType("boolean")
                        .HasColumnName("uses_default_working_days");
                    ...
                    b.ToTable("sorting_machines", (string)null);
                });

            modelBuilder.Entity("Confast.Web.Features.ProductionTracking.SortLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("ProductionSegmentId")
                        .HasColumnType("bigint")
                        .HasColumnName("production_segment_id");

                    b.Property<decimal>("TargetPphSnapshot")
                        .HasPrecision(24)
                        .HasColumnType("numeric(24,0)")
                        .HasColumnName("target_pph_snapshot");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_sort_logs");

                    b.HasIndex("CreatedByUserId")
                        .HasDatabaseName("IX_sort_logs_created_by_user_id");

                    b.HasIndex("InspectionId")
                        .HasDatabaseName("IX_sort_logs_inspection_id");

                    b.HasIndex("MachineId")
                        .HasDatabaseName("IX_sort_logs_machine_id");

                    b.HasIndex("PartId")
                        .HasDatabaseName("IX_sort_logs_part_id");

                    b.HasIndex("ProductionSegmentId")
                        .HasDatabaseName("IX_sort_logs_production_segment_id");

                    b.HasIndex("ProductionDate", "MachineId", "PartId", "InspectionId")
                        .IsUnique()
                        .HasDatabaseName("UX_sort_logs_daily_job");

                    b.ToTable("sort_logs", null, t =>
                        {
                            t.HasCheckConstraint("CK_sort_logs_comments", "comments IS NULL OR char_length(comments) <= 4000");

                            t.HasCheckConstraint("CK_sort_logs_target_pph", "target_pph_snapshot > 0");
                        });
                });

            modelBuilder.Entity("Confast.Web.Features.ProductionTracking.SortLogDowntimeCause", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("PK_sort_log_downtime_causes");
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionTracking.SortLogLine", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("BoundarySamplesPassedQuantity")
                        .HasColumnType("bigint")
                        .HasColumnName("boundary_samples_passed_quantity");

                    b.Property<long>("BoundarySamplesRanQuantity")
                        .HasColumnType("bigint")
                        .HasColumnName("boundary_samples_ran_quantity");

                    b.Property<long?>("DowntimeCauseId")
                        .HasColumnType("bigint")
                        .HasColumnName("downtime_cause_id");

                    b.Property<long?>("EndBoxCount")
                        .HasColumnType("bigint")
                        .HasColumnName("end_box_count");

                    b.Property<long>("FailQuantity")
                        .HasColumnType("bigint")
                        .HasColumnName("fail_quantity");
                    ...
                    b.Property<string>("QualityUserId")
                        .HasColumnType("text")
                        .HasColumnName("quality_user_id");

                    b.Property<int>("Sequence")
                        .HasColumnType("integer")
                        .HasColumnName("sequence");

                    b.Property<long>("SortLogId")
                        .HasColumnType("bigint")
                        .HasColumnName("sort_log_id");

                    b.Property<long?>("StartBoxCount")
                        .HasColumnType("bigint")
                        .HasColumnName("start_box_count");

                    b.Property<DateTimeOffset>("StartTimeUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("start_time_utc");

                    b.Property<DateTimeOffset?>("StopTimeUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("stop_time_utc");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_sort_log_lines");

                    b.HasIndex("DowntimeCauseId")
                        .HasDatabaseName("IX_sort_log_lines_downtime_cause_id");

                    b.HasIndex("ProductionUserId")
                        .HasDatabaseName("IX_sort_log_lines_production_user_id");

                    b.HasIndex("QualityUserId")
                        .HasDatabaseName("IX_sort_log_lines_quality_user_id");

                    b.HasIndex("SortLogId")
                        .IsUnique()
                        .HasDatabaseName("UX_sort_log_lines_active")
                        .HasFilter("stop_time_utc IS NULL");

                    b.HasIndex("SortLogId", "Sequence")
                        .IsUnique()
                        .HasDatabaseName("UX_sort_log_lines_sequence");
                    ...
                    b.ToTable("sort_log_lines", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_sort_log_lines_time", "stop_time_utc IS NULL OR stop_time_utc >= start_time_utc");
                        });
                });
            ...
            modelBuilder.Entity("Confast.Web.Features.ContainerTracking.ContainerReceiptAllocation", b =>
                {
                    b.HasOne("Confast.Web.Features.ContainerTracking.ContainerGroupPart", "ContainerGroupPart")
                        .WithMany("ReceiptAllocations")
                        .HasForeignKey("ContainerGroupPartId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("ContainerGroupPart");
            ...
            modelBuilder.Entity("Confast.Web.Features.ContainerTracking.ContainerReceivedQuantityHistory", b =>
                {
                    b.HasOne("Confast.Web.Features.ContainerTracking.ContainerGroupPart", "ContainerGroupPart")
                        .WithMany("ReceivedQuantityHistory")
                        .HasForeignKey("ContainerGroupPartId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.DefaultWorkingDay", b =>
                {
                    b.HasOne("Confast.Web.Features.ProductionScheduling.ProductionSettings", null)
                        .WithMany("DefaultWorkingDays")
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.MachineDowntime", b =>
                {
                    b.HasOne("Confast.Web.Features.ProductionScheduling.SortingMachine", null)
                        .WithMany()
                        .HasForeignKey("MachineId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Confast.Web.Features.ProductionScheduling.DowntimeReason", "Reason")
                        .WithMany()
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.ProductionJob", b =>
                {
                    b.HasOne("Confast.Web.Features.ContainerTracking.ContainerGroupPart", null)
                        .WithMany()
                        .HasForeignKey("ContainerGroupPartId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.ProductionProgress", b =>
                {
                    ...
                    b.HasOne("Confast.Web.Features.ProductionScheduling.ProductionSegment", null)
                        .WithMany("Progress")
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionTracking.SortLog", b =>
                {
                    ...
                    b.HasOne("Confast.Web.Features.ProductionScheduling.SortingMachine", "Machine")
                        .WithMany()
                        .HasForeignKey("MachineId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Confast.Web.Features.ProductionScheduling.ProductionSegment", "ProductionSegment")
                        .WithMany()
                        .HasForeignKey("ProductionSegmentId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("ProductionSegment");
                });

            modelBuilder.Entity("Confast.Web.Features.ProductionTracking.SortLogLine", b =>
                {
                    b.HasOne("Confast.Web.Features.ProductionTracking.SortLogDowntimeCause", "DowntimeCause")
                        .WithMany()
                        .HasForeignKey("DowntimeCauseId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Confast.Web.Features.Identity.ApplicationUser", "ProductionUser")
                        .WithMany()
                        .HasForeignKey("ProductionUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Confast.Web.Features.Identity.ApplicationUser", "QualityUser")
                        .WithMany()
                        .HasForeignKey("QualityUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Confast.Web.Features.ProductionTracking.SortLog", "SortLog")
                        .WithMany("Lines")
                        .HasForeignKey("SortLogId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("DowntimeCause");

                    b.Navigation("ProductionUser");

                    b.Navigation("QualityUser");

                    b.Navigation("SortLog");
                });
            ...
            modelBuilder.Entity("Confast.Web.Features.ContainerTracking.ContainerGroupPart", b =>
                {
                    ...
                    b.Navigation("ReceivedQuantityHistory");
                });
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.ProductionSettings", b =>
                {
                    b.Navigation("DefaultWorkingDays");
                });
