...
namespace Confast.Web.Data.Migrations
{
    ...
    [Migration("20260824195245_AddVersionedInspectionCriteria")]
    partial class AddVersionedInspectionCriteria
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("inspection_criteria", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_inspection_criteria_minimum_maximum", "minimum_value IS NULL OR maximum_value IS NULL OR minimum_value <= maximum_value");
                        });
                });
