...
namespace Confast.Web.Data.Migrations
{
    ...
    [Migration("20260910202719_AddProductionSchedulingIntegrity")]
    partial class AddProductionSchedulingIntegrity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.MachineWorkingDay", b =>
                {
                    ...
                    b.ToTable("machine_working_days", null, t =>
                        {
                            t.HasCheckConstraint("ck_machine_hours", "day BETWEEN 0 AND 6 AND hours >= 0 AND hours <= 24");
                        });
                });
            ...
            modelBuilder.Entity("Confast.Web.Features.ProductionScheduling.ProductionSettings", b =>
                {
                    ...
                    b.ToTable("production_settings", null, t =>
                        {
                            t.HasCheckConstraint("ck_production_efficiency", "id = 1 AND efficiency_percent > 0 AND efficiency_percent <= 100");
                        });
